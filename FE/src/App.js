            ...
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <div className="tg-userlogin">
                <figure>
                  <a href="./">
                    <img
                      src="assets/images/users/img-01.jpg"
                  ...
                  >
                    <div className="tg-minicartbody">
                      ...
                      <div className="tg-minicarproduct">
                        <figure>
                          <img
                            src="assets/images/products/img-02.jpg"
                            alt="image description"
                          />
                        </figure>
                        <div className="tg-minicarproductdata">
                          <h5>
                            <a href="./">Bring Me To Light</a>
                          </h5>
                          <h6>
                            <a href="./">$ 12.15</a>
                          </h6>
                      ...
                      <div className="tg-minicarproduct">
                        <figure>
                          <img
                            src="assets/images/products/img-03.jpg"
                            alt="image description"
                          />
                        </figure>
                        <div className="tg-minicarproductdata">
                          <h5>
                            <a href="./">Have Faith In Your Soul</a>
                          </h5>
                          <h6>
                            <a href="./">$ 12.15</a>
                          </h6>
